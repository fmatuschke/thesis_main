...
/data/PLI-Group/felix/data/thesis/env-$(hostname)/bin/python3 \
   simulation_mp.py \
   -i ${MODEL_PATH}/*omega_0.00_*r_0.50_*.solved.h5 \
   ...
   -p 48
#
python3 simulation_post_0.py -i /data/PLI-Group/felix/data/thesis/2_simulation/1_cubes/output/${NAME}_single -p 48
python3 simulation_post_1.py -i /data/PLI-Group/felix/data/thesis/2_simulation/1_cubes/output/${NAME}_single -p 48
python3 simulation_post_2.py -i /data/PLI-Group/felix/data/thesis/2_simulation/1_cubes/output/${NAME}_single -p 48
#
# two flat
/data/PLI-Group/felix/data/thesis/env-$(hostname)/bin/python3 \
   simulation_mp.py \
   -i ${MODEL_PATH}/*r_0.5_.solved.h5 \
