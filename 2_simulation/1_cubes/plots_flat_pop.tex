...
\addplot[BLUE!75] fill between [of=A and B];
...
\begin{axis}[%
   ...
   \addlegendimage{GREEN,mark=square*, only marks}
   \addlegendentry{data};
   \addlegendimage{black,mark=none, dotted}
   \addlegendentry{pop orientation};
   \addlegendimage{BLUE,mark=square*, only marks}
   \addlegendentry{25-75};
