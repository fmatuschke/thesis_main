...
\node[anchor=south] at ($(group c1r1.north)!0.5!(group c2r1.north) + (0,0.5)$) {inclined fiber pop., $\modelPsi = \SI[round-mode=places,round-precision=0]{\psivalueint}{\percent}$};
