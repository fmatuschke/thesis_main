...
\def\datapath{output/vs_120_0.25_6_25/results}
% 
\begin{document}
\pgfmathsetmacro{\ng}{6}
...
\foreach \vs in {0.5,1.0,2.0,5.0,10.0,20.0} {#1}}} %0.01, 
% 
\foreach \setup [count=\k] in {LAP} { % LAP
...
% 
\nextgroupplot[ylabel={data diff rel}, ymode={log}, ymin=0.00001, ymax=0.1,
...
% 
\nextgroupplot[ylabel={data diff rel}, ymode={log}, ymin=0.00001, ymax=0.1] %, ymode={log} % , ymin=0.0000001
\def\omega{0.0}
\def\psi{1.0}
\def\finc{90}
\Loop{
