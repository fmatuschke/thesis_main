...
\def\datapath{output/fr_120_0.125_6/results}
\def\vs{0.125}
% 
\begin{document}
\pgfmathsetmacro{\ng}{4}
...
\pgfplotsset{
    Boxplot/.style={
        ...
        boxplot={
            draw position={1-\dx/2+floor((\plotnumofactualtype+0.002)/\ng) + \dx/(\ng-1)*mod(\plotnumofactualtype,\ng)},
            box extend=\dx/(\ng+1),
            mark size=0.42pt,
            draw/median/.code={%
...
% 
\newcommand{\Loop}[1]{
\foreach \r in {1.0,2.0,5.0,10.0} {#1}}
% 
...
% 
\nextgroupplot[ylabel={data diff rel}, ymode={log}, ymin=0.002, ymax=1,
...
% 
\nextgroupplot[ylabel={data diff rel}, ymode={log}, ymin=0.002, ymax=1] %, ymode={log} % , ymin=0.0000001
\def\omega{0.0}
\def\psi{1.0}
\def\finc{90}
\Loop{
