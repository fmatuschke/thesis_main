...
\def\datapath{output/vs_0.01_6_25/results}
% 
\begin{document}
\pgfmathsetmacro{\ng}{6}
...
% \foreach \omega/\psi/\finc [count=\i] in {0.0/1.0/0,0.0/1.0/90,90.0/0.5/0,90.0/0.5/90} { %
% 
\directlua{tex.print('\string\\message{\k, \l, \m, \i}')}
% 
\begin{tikzpicture}[]
\begin{groupplot}[%
  group style={
...
\nextgroupplot[ylabel={trans rel}, %ymode={log},
               ...
               legend to name={legend\currfilebase\i\k\l\m},
...
\Loop{
    \addplot+[fill, draw=black] table[%
        ...
        ]{\datapath/vs_stats_omega_\omega_psi_\psi_f0_inc_\finc_mode_\mode_species_\species_setup_\setup_vs_\vs_r_\r_m_0.csv};
}
% 
\node[anchor=south] (title) at ({axis description cs:0.5,1.0}) {\mode/\species/\setup/\omega/\psi/\finc};
\xachse
% 
\nextgroupplot[ylabel={dir},]
\Loop{
    \addplot+[fill, draw=black] table[%
        y={epa_dir_diff}, y expr=\thisrow{epa_dir_diff}*180/3.141, col sep=comma, row sep=newline,
        ]{\datapath/vs_stats_omega_\omega_psi_\psi_f0_inc_\finc_mode_\mode_species_\species_setup_\setup_vs_\vs_r_\r_m_0.csv};
}
\xachse
% 
...
\Loop{
    % \directlua{tex.print('\string\\message{\datapath/vs_stats_omega_\omega_psi_\psi_f0_inc_\finc_mode_\mode_species_\species_setup_\setup_vs_\vs_r_\r_m_0.csv }')}
    \addplot+[fill, draw=black] table[%
...
\xachse
% 
\nextgroupplot[ylabel={data diff rel}, ymode={log}] %, ymode={log} % , ymin=0.0000001
\Loop{
    % \directlua{tex.print('\string\\message{vs_stats_omega_\omega_psi_\psi_f0_inc_\finc_mode_\mode_species_\species_setup_\setup_vs_\vs_r_\r_m_0.csv}')}
    \addplot+[fill, draw=black] table[%
...
\end{groupplot}
% 
\node[anchor=north] at ($(group c1r4.south) - (0,0.75cm)$) {\ref{legend\currfilebase\i\k\l\m}};
% 
\end{tikzpicture}
}}}}
% 
