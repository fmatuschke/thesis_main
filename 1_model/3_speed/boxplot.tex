...
\begin{tikzpicture}[]
  \begin{axis}[%
    ...
    \draw[black, dashed] ({axis cs:1,1}) -- ({axis cs:5.5,5.5}) node[sloped, pos=0.75, above] {ideal}; 
    \end{scope}
  %   
  ...
  % 
  \draw[dotted, thin] (axis cs:1.5,1) -- (axis cs:1.5,5.5);
  \draw[dotted, thin] (axis cs:2.5,1) -- (axis cs:2.5,5.5);
  \draw[dotted, thin] (axis cs:3.5,1) -- (axis cs:3.5,5.5);
  \draw[dotted, thin] (axis cs:4.5,1) -- (axis cs:4.5,5.5);
  \draw[dotted, thin] (axis cs:5.5,1) -- (axis cs:5.5,5.5);
  \draw[dotted, thin] (axis cs:6.5,1) -- (axis cs:6.5,5.5);
  \draw[dotted, thin] (axis cs:7.5,1) -- (axis cs:7.5,5.5);
  \draw[dotted, thin] (axis cs:8.5,1) -- (axis cs:8.5,5.5);
  ...
  \coordinate (L) at ($(PA)!0.5!(PB)$);
  % 
  % \draw[blue, thick] (L |- B) circle[radius=2pt];
  \node[anchor=north, yshift=0em] at (L |- B) {\ref{legend1}};
  %  
  % center axis
...
\begin{tikzpicture}[]
  \begin{axis}[%
    ...
    \draw[black, dashed] ({axis cs:1,1}) -- ({axis cs:8,8}) node[sloped, pos=0.75, above] {ideal}; 
  ...
  % 
  \draw[dotted, thin] (axis cs:1.5,1) -- (axis cs:1.5,10);
  \draw[dotted, thin] (axis cs:2.5,1) -- (axis cs:2.5,10);
  \draw[dotted, thin] (axis cs:3.5,1) -- (axis cs:3.5,10);
  \draw[dotted, thin] (axis cs:4.5,1) -- (axis cs:4.5,10);
  \draw[dotted, thin] (axis cs:5.5,1) -- (axis cs:5.5,10);
  \draw[dotted, thin] (axis cs:6.5,1) -- (axis cs:6.5,10);
  \draw[dotted, thin] (axis cs:7.5,1) -- (axis cs:7.5,10);
  \draw[dotted, thin] (axis cs:8.5,1) -- (axis cs:8.5,10);
  \draw[dotted, thin] (axis cs:9.5,1) -- (axis cs:9.5,10);
  \draw[dotted, thin] (axis cs:10.5,1) -- (axis cs:10.5,10);
  \draw[dotted, thin] (axis cs:11.5,1) -- (axis cs:11.5,10);
  \draw[dotted, thin] (axis cs:12.5,1) -- (axis cs:12.5,10);
  \node [anchor=base west] at (last.base east) {$n_{threads}$};
  % 
  \coordinate (PA) at (rel axis cs:0,0);
  \coordinate (PB) at (rel axis cs:1,0);
  ...
  % 
  % \draw[blue, thick] (L |- B) circle[radius=2pt];
  \node[anchor=north, yshift=0em] at (L |- B) {\ref{legend2}};
  %  
  % center axis
  \coordinate (PC) at (current bounding box.west);
  \path[] let \p1 = ($(PA)-(PC)$) in ($(PA) - (\x1,0)$) -- ($(PB) + (\x1,0)$);
