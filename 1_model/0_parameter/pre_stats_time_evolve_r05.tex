...
%    }
% % 
\nextgroupplot[ylabel={$\# steps$}, ymin=30, ymax=100000]
   \Loop{
    \addplot+[] table[
   ...
   \axisnode
\nextgroupplot[ylabel={$\# col obj$}, ymin=0, ymax=10000000]
   \Loop{
    \addplot+[] table[
   ...
   \axisnode
\nextgroupplot[ylabel={$overlap frac$}, ymin=0.0001, ymax=0.5]
    \Loop{
    \addplot+[] table[
    ...
    \axisnode
\nextgroupplot[ylabel={$\# obj$}, ymin=40000, ymax=1000000]
   \Loop{
    \addplot+[] table[
   ...
   \axisnode
\nextgroupplot[ylabel={$\Delta t / \si{\second}$}, xmin=30, xmax=100000, ymin = 1, ymax = 300,
   ...
   \Loop{
    \addplot+[] table[
        x={steps_mean}, y={dt_mean}, x error = {steps_std} , y error={dt_std}, col sep=comma,]
        {\datapath/cube_stat_time_evolve_r_\r_psi_\psi_fr_\fr_fl_\fl_.csv};
   }
...
\path node[anchor=north] at ($(group c1r5.south) - (0,0.75cm)$) {\ref{legend\ipsi}};
\end{tikzpicture}
}
\end{document}
